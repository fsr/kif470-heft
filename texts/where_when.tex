...
Ist das Guthaben aufgebraucht, habt ihr die Möglichkeit, die Karte entweder selbst an einer beliebigen Kasse in der Mensa neu aufzuladen oder ihr fragt einfach am Infopoint ob vielleicht noch Karten übrig sind.
...
Am anderen Ende des Campus, hinter ca. 20 Minuten Fußweg, liegt der Siede~$\bullet$.
...
% TODO: Ablauf abklären
\begin{awesomeblock}[KIFteal]{2pt}{\faQuestion}{KIFteal}
    \textbf{Ticketkonzept beim Grillen:}

    Ticket ziehen $\longrightarrow$ Warten $\longrightarrow$ Bei Aufruf Grillgut abholen
\end{awesomeblock}
...
Als Ort der Waffelbäckerei ist der Teich zu wählen.
